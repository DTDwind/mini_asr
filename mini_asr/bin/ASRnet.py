...
from mini_asr.bin.DataLoader import test_dataset_loader
...
class ASRnet(nn.Module):
    ...
    def __init__(self, model, optimizer, trainfunc, nPerSpeaker, **kwargs):
        ...
        ASRnetModel = importlib.import_module('models.'+model).__getattribute__('MainModel')
        self.__S__ = ASRnetModel(**kwargs);
